...
namespace SFA.DAS.ProviderPayments.Calc.PaymentsDue.Services
{
    ...
    {
        public EarningValidationResult DeterminePayableEarnings(List<DatalockOutput> successfulDatalocks, List<RawEarning> earnings, List<RawEarningForMathsOrEnglish> mathsAndEnglishEarnings,
