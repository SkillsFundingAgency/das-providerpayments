...
namespace SFA.DAS.ProviderPayments.Calc.PaymentsDue.UnitTests
{
    ...
    public class GivenACompletionPaymentService
    {
        ...
        {
            var result = sut.IsThereEvidenceOfSufficientEmployerPayments(new List<LearnerSummaryPaymentEntity>(), new RawEarning());
            ...
            CheckEmployerPayments sut)
        {
            ...
            var result = sut.IsThereEvidenceOfSufficientEmployerPayments(paymentHistory, rawEarning);
