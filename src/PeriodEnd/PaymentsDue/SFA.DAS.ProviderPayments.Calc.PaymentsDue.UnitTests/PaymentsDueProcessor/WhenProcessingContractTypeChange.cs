...
{
    public class WhenProcessingContractTypeChange : WhenProcessingValidScenarioBase
    {
        ...
        [Test]
        public void ThenItShouldOuputPaymentsDueForEarningsThatHaveBeenFullyPaidInPreviousRunsIfTheContractTypeHasChanged()
        {
            // Arrange
