...
SELECT
    ...
    END) AS EarningAmount,
        ...
        FROM Reference.ApprenticeshipEarnings ae
            ...
            LEFT JOIN DataLock.PriceEpisodeMatch pem 
				ON ae.Ukprn = pem.Ukprn
            ...
            LEFT JOIN DataLock.PriceEpisodePeriodMatch pepm 
				ON ae.Ukprn = pepm.Ukprn
            ...
            LEFT JOIN Reference.DasCommitments c 
				ON c.CommitmentId = pepm.CommitmentId
                AND c.VersionId = pepm.VersionId
            LEFT JOIN Reference.DasAccounts a 
				ON c.AccountId = a.AccountId
			LEFT JOIN Staging.NonDasTransactionTypes ndtt 
				ON ndtt.ApprenticeshipContractType = ae.ApprenticeshipContractType
