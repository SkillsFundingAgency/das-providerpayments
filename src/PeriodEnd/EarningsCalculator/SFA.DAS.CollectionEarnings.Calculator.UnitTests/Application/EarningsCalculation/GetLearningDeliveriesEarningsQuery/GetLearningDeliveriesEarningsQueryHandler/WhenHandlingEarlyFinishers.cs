...
namespace SFA.DAS.CollectionEarnings.Calculator.UnitTests.Application.EarningsCalculation.GetLearningDeliveriesEarningsQuery.GetLearningDeliveriesEarningsQueryHandler
{
    public class WhenHandlingEarlyFinishers
    {
        ...
        private static readonly object[] LearningDeliveriesToProcessWithSubmissionAndYearOfCollectionDatesAndExpectedOnProgrammeSchedule =
        {
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 1)).WithLearnActEndDate(new DateTime(2018, 8, 31)).Build()},
                ...
                "expecting a monthly installment of 1000.00 in the first period for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 31/08/2018, has a negociated price of 15000 and is submitted on 15/10/2018."
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 01)).WithLearnActEndDate(new DateTime(2018, 9, 30)).Build()},
                new DateTime(2018, 10, 15),
                new DateTime(2018, 8, 1),
                new[] {1000.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m},
                "expecting a monthly installment of 1000.00 in the first period for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 30/09/2018, has a negociated price of 15000 and is submitted on 15/10/2018."
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 01)).WithLearnActEndDate(new DateTime(2018, 8, 31)).Build()},
                ...
                "expecting monthly installments of 1000.00 starting from the second period for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 31/08/2018, has a negociated price of 15000 and is submitted on 15/10/2017."
            }
        };
        ...
        private static readonly object[] LearningDeliveriesToProcessWithSubmissionAndYearOfCollectionDatesAndExpectedCompletionSchedule =
        {
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 30)).WithLearnActEndDate(new DateTime(2018, 8, 31)).Build()},
                new DateTime(2018, 10, 15),
                new DateTime(2018, 8, 1),
                new[] {3000.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m},
                "expecting a completion payment of 3000.00 in the first period for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 31/08/2018, has a negociated price of 15000 and is submitted on 15/10/2018."
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 30)).WithLearnActEndDate(new DateTime(2018, 9, 30)).Build()},
                new DateTime(2018, 10, 15),
                new DateTime(2018, 8, 1),
                new[] {0.00m, 3000.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m},
                "expecting a completion payment of 3000.00 in the second period for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 30/09/2018, has a negociated price of 15000 and is submitted on 15/10/2018."
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 30)).WithLearnActEndDate(new DateTime(2018, 8, 31)).Build()},
                ...
                "expecting no completion payments for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 31/08/2018, has a negociated price of 15000 and is submitted on 15/10/2017."
            }
        };
        ...
        private static readonly object[] LearningDeliveriesToProcessWithSubmissionAndYearOfCollectionDatesAndExpectedBalancingSchedule =
        {
            new object[]
            {
                ...
                new DateTime(2018, 8, 1),
                new[] {0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m},
                "expecting no balancing payment for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 31/08/2018, has a negociated price of 15000 and is submitted on 15/10/2018."
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 1)).WithLearnActEndDate(new DateTime(2018, 7, 31)).Build()},
                new DateTime(2017, 10, 15),
                new DateTime(2017, 8, 1),
                new[] {0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 1000.00m},
                "expecting a balancing payment of 1000.00 in the 12th period for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 31/07/2018, has a negociated price of 15000 and is submitted on 15/10/2017."
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 8)).WithLearnActEndDate(new DateTime(2018, 6, 30)).Build()},
                new DateTime(2017, 10, 15),
                new DateTime(2017, 8, 1),
                new[] {0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 2000.00m, 0.00m },
                "expecting a balancing payment of 2000.00 in the 12th period for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 30/06/2018, has a negociated price of 15000 and is submitted on 15/10/2017."
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 8)).WithLearnActEndDate(new DateTime(2018, 9, 30)).Build()},
                new DateTime(2018, 10, 15),
                new DateTime(2018, 8, 1),
                new[] {0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m},
                "expecting no balancing payment for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 30/09/2018, has a negociated price of 15000 and is submitted on 15/10/2018."
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 8)).WithLearnActEndDate(new DateTime(2018, 8, 31)).Build()},
                new DateTime(2017, 10, 15),
                new DateTime(2017, 8, 1),
                new[] {0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m},
                "expecting no balancing payment for a learning episode that starts on 01/09/2017, runs for 12 months, finishes early on 31/08/2018, has a negociated price of 15000 and is submitted on 15/10/2017."
            }
        };
        ...
        private static readonly object[] LearningDeliveriesToProcessWithSubmissionAndYearOfCollectionDatesAndExpectedPeriodsSchedule =
       {
            new object[]
            {
                ...
                new[] {1000.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m},
                new[] {3000.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m},
                new[] {00.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, 0.00m}
            },
            new object[]
            {
                new[] {new LearningDeliveryBuilder().WithLearnPlanEndDate(new DateTime(2018, 9, 8)).WithLearnActEndDate(new DateTime(2018, 7, 31)).Build()},
                new DateTime(2017, 10, 15),
                new DateTime(2017, 8, 1),
                new[] {0.00m, 1000.00m, 1000.00m, 1000.00m, 1000.00m, 1000.00m, 1000.00m, 1000.00m, 1000.00m, 1000.00m, 1000.00m, 1000.00m},
