...
Scenario: Learner Completes and progresses - commitment is stopped - no datalocks
	...
	And I have the following commitments
		| CommitmentId | VersionId   | AccountId | StartDate  | EndDate    | AgreedCost | Standard | Prog | Framework | Pathway | Status | StatusDescription | EffectiveFromDate | EffectiveToDate | WithdrawnOnDate |
