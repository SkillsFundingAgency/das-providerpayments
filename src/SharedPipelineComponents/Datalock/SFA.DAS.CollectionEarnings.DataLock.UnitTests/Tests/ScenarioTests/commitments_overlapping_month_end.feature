...
Scenario: Learner Completes and progresses - commitment is not stopped - no datalocks
	...
	And I have the following commitments
		| CommitmentId | VersionId   | AccountId | StartDate  | EndDate    | AgreedCost | Standard | Prog | Framework | Pathway | PaymentStatus | PaymentStatusDescription | EffectiveFromDate | EffectiveToDate | 
		| 12526        | 2957434-001 | 13577     | 2017-06-01 | 2018-06-01 | 1950.00    | 0        | 3    | 490       | 1       | 1             | Active                   | 2017-06-01        | NULL            | 
		| 277697       | 2600007-001 | 13577     | 2018-06-01 | 2019-10-01 | 2450.00    | 0        | 2    | 490       | 1       | 1             | Active                   | 2018-06-01        | NULL            | 
