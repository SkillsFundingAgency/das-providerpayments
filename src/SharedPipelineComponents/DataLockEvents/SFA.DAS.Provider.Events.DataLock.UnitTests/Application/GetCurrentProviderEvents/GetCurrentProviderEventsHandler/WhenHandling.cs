...
namespace SFA.DAS.Provider.Events.DataLock.UnitTests.Application.GetCurrentProviderEvents.GetCurrentProviderEventsHandler
{
    public class WhenHandling
    {
        ...
        public void ThenItShouldMapEntityToDomainModelCorrectly()
        {
            ...
            Assert.AreEqual(TransactionTypeGroup.OnProgLearning, actualEvent.Periods[0].TransactionTypesFlag);
            ...
            Assert.AreEqual(TransactionTypeGroup.OnProgLearning, actualEvent.Periods[1].TransactionTypesFlag);
