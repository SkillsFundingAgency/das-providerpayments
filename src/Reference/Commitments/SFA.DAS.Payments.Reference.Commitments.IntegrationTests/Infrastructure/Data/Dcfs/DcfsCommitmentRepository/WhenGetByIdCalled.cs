...
{
    public class WhenGetByIdCalled
    {
        ...
        [Test]
        public void ThenItShouldGetLatestVersion()
        {
            // Arrange
            CommitmentDataHelper.AddCommitment(_commitment.CommitmentId, _commitment.AccountId
                      , _commitment.Uln, _commitment.Ukprn, _commitment.StartDate, _commitment.EndDate, _commitment.AgreedCost,
            ...
            Assert.AreEqual(commitment.VersionId, "2-001");
            Assert.AreEqual(commitment.EffectiveFromDate, new DateTime(2017, 10, 10));
