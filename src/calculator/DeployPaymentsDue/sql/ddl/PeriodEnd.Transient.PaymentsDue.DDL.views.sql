...
AS
	...
	FROM (
		SELECT
			...
			COALESCE(pepm.TransactionType, nonDas.TransactionType) AS TransactionType,
			(CASE COALESCE(pepm.TransactionType, nonDas.TransactionType)
		...
		FROM Reference.ApprenticeshipEarnings ae
			...
			LEFT JOIN PaymentsDue.vw_NonDasTransactionTypes	nonDas ON nonDas.ApprenticeshipContractType = ae.ApprenticeshipContractType
