...
namespace SFA.DAS.ProviderPayments.Calc.PaymentsDue.IntegrationTests.FinishedOnTime
{
    public class WhenALearnerMovesStartDateForward
    {
        ...
        public void ThenItShouldCreateReversalPaymentsForPreviousMonthsInIlr()
        {
            ...
            TestDataHelper.AddEarningForNonDas(ukprn, startDate.AddMonths(2), plannedEndDate.AddMonths(2), 15000, learnerRefNumber, currentPeriod: 5, uln: uln);
        ...
        [Test]
        public void ThenItShouldCreateReversalPaymentsForPreviousMonthsInIlrWhenStartDateIsMoved()
        {
            // Arrange
            var ukprn = 863145;
            var commitmentId = 1L;
            ...
            TestDataHelper.UpdateOnProgApprenticeEarning(ukprn, learnerRefNumber, 1, 0);
            TestDataHelper.UpdateOnProgApprenticeEarning(ukprn, learnerRefNumber, 2, 0);
