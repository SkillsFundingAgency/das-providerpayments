...
using SFA.DAS.ProviderPayments.Calc.PaymentSchedule.IntegrationTests.Tools;
using SFA.DAS.ProviderPayments.Calc.Common.Context;
using SFA.DAS.ProviderPayments.Calc.Common.Tools.Extensions;

namespace SFA.DAS.ProviderPayments.Calc.PaymentSchedule.IntegrationTests.FinishedOnTime
{
    public class WhenSchedulingPayments
    {
        private readonly IExternalTask _task = new PaymentScheduleTask();
