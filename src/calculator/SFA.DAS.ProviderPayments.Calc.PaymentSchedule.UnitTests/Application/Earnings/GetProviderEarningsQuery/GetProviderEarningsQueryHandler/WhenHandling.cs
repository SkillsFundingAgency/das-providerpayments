...
namespace SFA.DAS.ProviderPayments.Calc.PaymentSchedule.UnitTests.Application.Earnings.GetProviderEarningsQuery.GetProviderEarningsQueryHandler
{
    public class WhenHandling
    {
        ...
        private PaymentSchedule.Application.Earnings.GetProviderEarningsQuery.GetProviderEarningsQueryHandler _handler;
        ...
        public void Arrange()
        {
            ...
            _handler = new PaymentSchedule.Application.Earnings.GetProviderEarningsQuery.GetProviderEarningsQueryHandler(_repository.Object);
        }
