...
namespace SFA.DAS.ProviderPayments.Calc.PaymentSchedule.UnitTests.Application.RequiredPayments.AddRequiredPaymentsCommand.AddRequiredPaymentsCommandHandler
{
    public class WhenHandling
    {
        ...
        private PaymentSchedule.Application.RequiredPayments.AddRequiredPaymentsCommand.AddRequiredPaymentsCommandHandler _handler;
        ...
        public void Arrange()
        {
            ...
            _handler = new PaymentSchedule.Application.RequiredPayments.AddRequiredPaymentsCommand.AddRequiredPaymentsCommandHandler(_repository.Object);
        }
