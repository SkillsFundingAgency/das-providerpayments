...
namespace SFA.DAS.ProviderPayments.Calc.PaymentSchedule.UnitTests.Application.Providers.GetProvidersQuery.GetProvidersQueryHandler
{
    public class WhenHandling
    {
        ...
        private PaymentSchedule.Application.Providers.GetProvidersQuery.GetProvidersQueryHandler _handler;
        ...
        public void Arrange()
        {
            ...
            _handler = new PaymentSchedule.Application.Providers.GetProvidersQuery.GetProvidersQueryHandler(_repository.Object);
        }
