...
namespace SFA.DAS.ProviderPayments.Calc.PaymentSchedule.UnitTests.Application.CollectionPeriods.GetCurrentCollectionPeriodQuery.GetCurrentCollectionPeriodQueryHandler
{
    public class WhenHandling
    {
        ...
        private PaymentSchedule.Application.CollectionPeriods.GetCurrentCollectionPeriodQuery.GetCurrentCollectionPeriodQueryHandler _handler;
        ...
        public void Arrange()
        {
            ...
            _handler = new PaymentSchedule.Application.CollectionPeriods.GetCurrentCollectionPeriodQuery.GetCurrentCollectionPeriodQueryHandler(_repository.Object);
        }
