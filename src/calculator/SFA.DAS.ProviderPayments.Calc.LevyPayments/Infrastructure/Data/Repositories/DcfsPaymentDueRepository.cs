...
namespace SFA.DAS.ProviderPayments.Calc.LevyPayments.Infrastructure.Data.Repositories
{
    public class DcfsPaymentDueRepository : DcfsRepository, IPaymentDueRepository
    {
        ...
        private const string SelectDuePaymentsForCommitment = SelectDuePayments + " WHERE CommitmentId = @CommitmentId And TransactionType Not IN (4,5,6,7,8,9,10,11,12) AND UseLevyBalance = 1 ORDER BY DeliveryYear, DeliveryMonth ASC";
