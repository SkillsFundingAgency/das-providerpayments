							...
							select
								...
								(
									select
										...
										(
											select
												[LearningDelivery_LARS_LearningDelivery_LARS_FrameworkCmnComp].[FrameworkCommonComponent] as [@LARSFrameworkCommonComponentCode],
...
create procedure [Rulebase].[AEC_Insert_LearningDelivery]
	(
		...
		@ApplicCompDate date,
		@CappedLatestTNP decimal(10,5),
		@CappedProgrammeAimValue decimal(10,5),
...
create procedure [Rulebase].[AEC_PivotTemporals_LearningDelivery] as
	begin
		...
		select
			...
			max(case AttributeName when 'ProgrammeAimBalPct' then Value else null end) ProgrammeAimBalPct,
			...
			max(case AttributeName when 'ProgrammeAimOnProgPct' then Value else null end) ProgrammeAimOnProgPct
		from
			(
				select
					LearnRefNumber,
...
create procedure [Rulebase].[AEC_Insert_HistoricEarningOutput]
	(
		...
		@HistoricBalancingProgAimPaymentsInTheYear decimal(10,5),
		@HistoricCompletionProgAimPaymentsInTheYear decimal(10,5),
		@HistoricDaysInYearOutput int,
		@HistoricFworkCodeOutput int,
		@HistoricOnProgProgAimPaymentsInTheYear decimal(10,5),
...
GO
if object_id('[Rulebase].[AEC_Insert_ApprenticeshipPriceEpisode_PeriodisedTextValues]','p') is not null
	drop procedure [Rulebase].[AEC_Insert_ApprenticeshipPriceEpisode_PeriodisedTextValues]
GO
-- =====================================================================================================
-- Generated by Data Dictionary Version 1.0.0.0
-- Date: 23 January 2017 11:25
...
-- Rulebase Version: ILR Apprenticeship Earnings Calc 1617, Version 1617.11
-- =====================================================================================================
create procedure [Rulebase].[AEC_Insert_ApprenticeshipPriceEpisode_PeriodisedTextValues]
	(
		@LearnRefNumber varchar(12),
		@PriceEpisodeIdentifier varchar(25),
		@AttributeName varchar(100),
...
create procedure [Rulebase].[AEC_PivotTemporals_ApprenticeshipPriceEpisode] as
	begin
		...
		update
			[Rulebase].[AEC_ApprenticeshipPriceEpisode_Period]
		set
			PriceEpisodeFundLineType=Vic.PriceEpisodeFundLineType
		from
			[Rulebase].[AEC_ApprenticeshipPriceEpisode_Period]
			inner join
				(
					select
						...
						PriceEpisodeIdentifier,
						Period,
						max(case AttributeName when 'PriceEpisodeFundLineType' then Value else null end) PriceEpisodeFundLineType
					from
						(
							select
								LearnRefNumber,
					...
					on [AEC_ApprenticeshipPriceEpisode_Period].LearnRefNumber=Vic.LearnRefNumber
					and [AEC_ApprenticeshipPriceEpisode_Period].PriceEpisodeIdentifier=Vic.PriceEpisodeIdentifier
					and [AEC_ApprenticeshipPriceEpisode_Period].Period=Vic.Period
	end
GO
