                ...
                <instance>
                      ...
                      <instance>
                        ...
                        <entity>
                          ...
                          <xsl:for-each select="Standard_LARS_ApprenticshipFunding">
                            <xsl:variable name="var_StandardAF1618EmployerAdditionalPayment" select="@StandardAF1618EmployerAdditionalPayment"/>
                            <xsl:variable name="var_StandardAF1618FrameworkUplift" select="@StandardAF1618FrameworkUplift"/>
                            <xsl:variable name="var_StandardAF1618ProviderAdditionalPayment" select="@StandardAF1618ProviderAdditionalPayment"/>
                            ...
                            <xsl:variable name="var_StandardAFReservedValue3" select="@StandardAFReservedValue3"/>
                            <instance>
                              <xsl:attribute name="id">
                                <xsl:value-of select="generate-id(.)"/>
                              </xsl:attribute>
                        ...
                        <entity>
                          ...
                          <xsl:for-each select="Framework_LARS_ApprenticshipFunding">
                            <xsl:variable name="var_FrameworkAF1618EmployerAdditionalPayment" select="@FrameworkAF1618EmployerAdditionalPayment"/>
                            <xsl:variable name="var_FrameworkAF1618FrameworkUplift" select="@FrameworkAF1618FrameworkUplift"/>
                            <xsl:variable name="var_FrameworkAF1618ProviderAdditionalPayment" select="@FrameworkAF1618ProviderAdditionalPayment"/>
                            ...
                            <xsl:variable name="var_FrameworkAFReservedValue3" select="@FrameworkAFReservedValue3"/>
                            <instance>
                              <xsl:attribute name="id">
                                <xsl:value-of select="generate-id(.)"/>
                              </xsl:attribute>
                        ...
                        <entity>
                          ...
                          <xsl:for-each select="LearningDeliveryLARS_Funding">
                            <xsl:variable name="var_LARSFundCategory" select="@LARSFundCategory"/>
                            ...
                            <xsl:variable name="var_LARSFundWeightedRate" select="@LARSFundWeightedRate"/>
                            <instance>
                              <xsl:attribute name="id">
                                <xsl:value-of select="generate-id(.)"/>
                              </xsl:attribute>
                  ...
                  <entity>
                    ...
                    <xsl:for-each select="SFA_PostcodeDisadvantage">
                      <xsl:variable name="var_DisApprenticeshipUplift" select="@DisApprenticeshipUplift"/>
                  ...
                  <entity>
                    ...
                    <xsl:for-each select="HistoricEarningInput">
                      ...
                      <xsl:variable name="var_AppProgCompletedInTheYearInput" select="@AppProgCompletedInTheYearInput"/>
                      ...
                      <xsl:variable name="var_HistoricEffectiveTNPStartDateInput" select="@HistoricEffectiveTNPStartDateInput"/>
                      <xsl:variable name="var_HistoricEmpIdEndWithinYearInput" select="@HistoricEmpIdEndWithinYearInput"/>
                      <xsl:variable name="var_HistoricEmpIdStartWithinYearInput" select="@HistoricEmpIdStartWithinYearInput"/>
                      <xsl:variable name="var_HistoricFworkCodeInput" select="@HistoricFworkCodeInput"/>
                      <xsl:variable name="var_HistoricLearner1618AtStartInput" select="@HistoricLearner1618AtStartInput"/>
                      <xsl:variable name="var_HistoricLearnRefNumberInput" select="@HistoricLearnRefNumberInput"/>
                      <xsl:variable name="var_HistoricPMRAmountInput" select="@HistoricPMRAmountInput"/>
                      <xsl:variable name="var_HistoricProgrammeStartDateIgnorePathwayInput" select="@HistoricProgrammeStartDateIgnorePathwayInput"/>
                      <xsl:variable name="var_HistoricProgrammeStartDateMatchPathwayInput" select="@HistoricProgrammeStartDateMatchPathwayInput"/>
                      ...
                      <xsl:variable name="var_HistoricTNP1Input" select="@HistoricTNP1Input"/>
                      <xsl:variable name="var_HistoricTNP2Input" select="@HistoricTNP2Input"/>
                      <xsl:variable name="var_HistoricTNP3Input" select="@HistoricTNP3Input"/>
                      <xsl:variable name="var_HistoricTNP4Input" select="@HistoricTNP4Input"/>
                      <xsl:variable name="var_HistoricTotal1618UpliftPaymentsInTheYearInput" select="@HistoricTotal1618UpliftPaymentsInTheYearInput"/>
                      <xsl:variable name="var_HistoricTotalProgAimPaymentsInTheYearInput" select="@HistoricTotalProgAimPaymentsInTheYearInput"/>
                      ...
                      <xsl:variable name="var_HistoricVirtualTNP3EndofTheYearInput" select="@HistoricVirtualTNP3EndofTheYearInput"/>
                      <xsl:variable name="var_HistoricVirtualTNP4EndofTheYearInput" select="@HistoricVirtualTNP4EndofTheYearInput"/>
                      <xsl:variable name="var_HistoricLearnDelProgEarliestACT2DateInput" select="@HistoricLearnDelProgEarliestACT2DateInput"/>
                      <instance>
                        <xsl:attribute name="id">
                          <xsl:value-of select="generate-id(.)"/>
                        </xsl:attribute>
