...
Scenario: AC10 - 1 learner, non levy, LDM code 356 used, co-funding has been used and provider data shows enough employer contribution – pay completion

	Given the apprenticeship funding band maximum is 9000 

    When an ILR file is submitted for academic year 1617 in period R11 with the following data:
        | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM |
        | learner a | programme only non-DAS | 9000         | 06/06/2017 | 08/06/2018       |                 | continuing        | LDM356      |
	...
	And an ILR file is submitted for academic year 1718 in period R11 with the following data:
	    | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM | employer contribution |
        | learner a | programme only non-DAS | 9000         | 06/06/2017 | 08/06/2018       | 18/06/2018      | completed         | LDM356      | 720                    |
...
Scenario: AC11 - 1 learner, levy, LDM code 356 used, co-funding has been used and provider data shows not enough employer contribution – pay completion
	...
	And an ILR file is submitted for academic year 1718 in period R11 with the following data:
        | ULN       | learner type       | agreed price | start date | planned end date | actual end date | completion status |  LearnDelFAM | employer contribution | 
        | learner a | programme only DAS | 9000         | 06/06/2017 | 08/06/2018       | 18/06/2018      | completed         |  LDM356      | 1					  |
...
Scenario: AC12 - 1 learner, non levy, LDM code 356 used, co-funding has been used and provider data shows not enough employer contribution – pay completion
	...
	And an ILR file is submitted for academic year 1718 in period R11 with the following data:
        ...
        | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM | employer contribution |
        | learner a | programme only non-DAS | 9000         | 06/06/2017 | 08/06/2018       | 18/06/2018      | completed         | LDM356      | 1					   |
...
Scenario: AC13 - 1 learner, levy, LDM code 361 used, co-funding has been used and provider data shows enough employer contribution – pay completion
    ...
    When an ILR file is submitted for academic year 1617 in period R11 with the following data:
        | ULN       | learner type       | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM |
        | learner a | programme only DAS | 9000         | 06/06/2017 | 08/06/2018       | 	              | continuing        | LDM361		 |
	...
	And an ILR file is submitted for academic year 1718 in period R11 with the following data:
        | ULN       | learner type       | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM  | employer contribution | 
        | learner a | programme only DAS | 9000         | 06/06/2017 | 08/06/2018       | 18/06/2018      | completed         | LDM361		 | 720					  |
...
Scenario: AC14 - 1 learner, non levy, LDM code 361 used, co-funding has been used and provider data shows enough employer contribution – pay completion
    ...
    When an ILR file is submitted for academic year 1617 in period R11 with the following data:
        | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM  |
        | learner a | programme only non-DAS | 9000         | 06/06/2017 | 08/06/2018       | 	              | continuing        | LDM361		 |
	...
	And an ILR file is submitted for academic year 1718 in period R11 with the following data:
        | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM  | employer contribution |
        | learner a | programme only non-DAS | 9000         | 06/06/2017 | 08/06/2018       | 18/06/2018      | completed         | LDM361		 | 720					   |
...
Scenario: AC15 - 1 learner, levy, LDM code 361 used, co-funding has been used and provider data shows not enough employer contribution – pay completion
	...
	And an ILR file is submitted for academic year 1718 in period R11 with the following data:
        | ULN       | learner type       | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM  | employer contribution | 
        | learner a | programme only DAS | 9000         | 06/06/2017 | 08/06/2018       | 18/06/2018      | completed         | LDM361		 | 1					  |
...
Scenario: AC16 - 1 learner, non levy, LDM code 361 used, co-funding has been used and provider data shows not enough employer contribution – pay completion
	...
	And an ILR file is submitted for academic year 1718 in period R11 with the following data:
        | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | LearnDelFAM  | employer contribution |
        | learner a | programme only non-DAS | 9000         | 06/06/2017 | 08/06/2018       | 18/06/2018      | completed         | LDM361		 | 1					   |
