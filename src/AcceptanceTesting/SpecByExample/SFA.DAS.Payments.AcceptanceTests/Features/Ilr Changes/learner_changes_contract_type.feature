...
Scenario: DPP_965_04 - Levy apprentice, provider edits contract type (ACT) in the ILR, first ILR has one contract type for duration of learning and second ILR shows a change between two contract types 
    Given The learner is programme only DAS
	And levy balance > agreed price for all months
	And the apprenticeship funding band maximum is 9000
    ...
    And an ILR file is submitted for period R03 with the following data:
        ...
        |           |                    |              |            |                  |                 |                   |                  |                     |          |                |                |              | DAS           | 06/09/2017              |                       |
        | learner a | programme only DAS | 9000         | 06/08/2017 | 20/08/2018       |                 | continuing        | programme        | 2                   |          | 403            | 2              | 1            | Non-DAS       | 06/08/2017              | 05/09/2017            |
        |           |                    |              |            |                  |                 |                   |                  |                     |          |                |                |              | DAS           | 06/09/2017              |                       |		
...
Scenario: DPP_965_05 - Non-Levy apprentice, provider edits contract type (ACT) in the ILR, first ILR has one contract type for duration of learning and second ILR shows a change between two contract types 		
    Given levy balance > agreed price for all months
    And the apprenticeship funding band maximum is 9000
    ...
    And an ILR file is submitted for period R03 with the following data:
        ...
        |           |                    |              |            |                  |                 |                   |                  |                     |          |                |                |              | Non-DAS       | 06/09/2017              |                       |
        | learner a | programme only DAS | 9000         | 06/08/2017 | 20/08/2018       |                 | continuing        | programme        | 2                   |          | 403            | 2              | 1            | DAS           | 06/08/2017              | 05/09/2017            |
        |           |                    |              |            |                  |                 |                   |                  |                     |          |                |                |              | Non-DAS       | 06/09/2017              |                       |
