...
Scenario: DPP-966_01 - 16-18 Non-Levy apprentice, provider retrospectively adds small employer flag in the ILR, previous on-programme payments are refunded and repaid according to latest small employer status
        ...
        When an ILR file is submitted for period R01 with the following data:
            | ULN       | learner type                 | agreed price | start date | planned end date | actual end date | aim sequence number | aim type  | completion status | standard code | Employer Employment Status | Employer Employment Status Applies | Employer   | Employer Id | Employer Small Employer |
            | learner a | 16-18 programme only non-DAS | 9000         | 06/08/2017 | 20/08/2018       |                 | 1                   | programme | continuing        | 50            | in paid employment         | 05/08/2017                         | employer 1 | 12345678    | SEM1                    |
...
Scenario: DPP-966_02 - 16-18 Non-Levy apprentice, provider retrospectively removes small employer flag in the ILR, previous on-programme payments are refunded and repaid according to latest small employer status
      ...
      When an ILR file is submitted for period R01 with the following data:
            | ULN       | learner type                 | start date | aim sequence number | aim type  | completion status | standard code | Employment Status	| Employment Status Applies | Employer Id | Employer Small Employer |
            | learner a | 16-18 programme only non-DAS | 06/08/2017 | 1                   | programme | continuing        | 50            | in paid employment	| 05/08/2017	            | 12345678    |	SEM1           |
        
			       
      And an ILR file is submitted for period R03 with the following data:
            | ULN       | learner type                 | start date | aim sequence number | aim type  | completion status | standard code | Employment Status	| Employment Status Applies | Employer Id |
            | learner a | 16-18 programme only non-DAS | 06/08/2017 | 1                   | programme | continuing        | 50            | in paid employment	| 05/08/2017	            | 12345678    |
