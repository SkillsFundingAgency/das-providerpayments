...
Scenario:806_AC1- DAS learner, is made redundant within the last 6 months of planned learning - receives full government funding for the rest of the programme 
       ...
       When an ILR file is submitted for period R01 with the following data:
            | ULN       | learner type       | start date | planned end date | actual end date | completion status | Total training price | Total training price effective date | Total assessment price | Total assessment price effective date | employer   | employer employment status | employer employment status applies | contract type | contract type date from |
            | learner a | programme only DAS | 03/08/2017 | 20/08/2018       |                 | continuing        | 12000                | 03/08/2017                          | 3000                   | 03/08/2017                            | employer 0 | in paid employment         | 03/08/2017                         | DAS           | 03/08/2017              |
       
	    And an ILR file is submitted for period R07 with the following data:
            | ULN       | learner type       | start date | planned end date | actual end date | completion status | Total training price | Total training price effective date | Total assessment price | Total assessment price effective date | employer   | employer employment status | employer employment status applies | contract type | contract type date from | contract type date to |
            | learner a | programme only DAS | 03/08/2017 | 20/08/2018       |                 | continuing        | 12000                | 03/08/2017                          | 3000                   | 03/08/2017                            | employer 0 | in paid employment         | 03/08/2017                         | DAS           | 03/08/2017              | 20/02/2018            |
            |           |                    |            |                  |                 |                   |                      |                                     |                        |                                       | employer 0 | not in paid employment     | 21/02/2018                         | Non-DAS       | 21/02/2018              |                       |
...
Scenario:806_AC2- DAS learner, is made redundant outside of the last 6 months of planned learning - receives full government funding for the next 12 weeks only 
	    ...
	    And an ILR file is submitted for period R07 with the following data:
            | ULN       | learner type       | start date | planned end date | actual end date | completion status | Total training price | Total training price effective date | Total assessment price | Total assessment price effective date | employer   | employer employment status | employer employment status applies | contract type | contract type date from | contract type date to |
            | learner a | programme only DAS | 03/08/2017 | 20/08/2018       |                 | continuing        | 12000                | 03/08/2017                          | 3000                   | 03/08/2017                            | employer 0 | in paid employment         | 03/08/2017                         | DAS           | 03/08/2017              | 19/02/2018            |
            |           |                    |            |                  |                 |                   |                      |                                     |                        |                                       | employer 0 | not in paid employment     | 20/02/2018                         | Non-DAS       | 20/02/2018              |                       |
...
Scenario:808_AC1- DAS learner, is made redundant within the last 6 months of planned learning - receives full government funding for the rest of the programme, a provider incentive, but no employer incentive
        ...
        And levy balance > agreed price for all months
	    And the following commitments exist:
            | commitment Id | version Id | employer   | ULN       | framework code | programme type | pathway code | start date | end date   | agreed price | status | effective from | effective to |
            | 1             | 1          | employer 0 | learner a | 403            | 2              | 1            | 01/08/2017 | 01/08/2018 | 6125         | Active | 01/08/2017     |              |
        
	    When an ILR file is submitted with the following data:
	    	| ULN       | learner type             | aim type         | framework code | programme type | pathway code | agreed price | aim rate | start date | planned end date | actual end date | completion status | learning support code | learning support date from | learning support date to | contract type | contract type date from | contract type date to | employer   | employer employment status | employer employment status applies |
	    	| learner a | 16-18 programme only DAS | programme        | 403            | 2              | 1            | 6125         |          | 06/08/2017 | 20/10/2018       | 08/08/2018      | completed         | 1                     | 06/08/2017                 | 20/10/2018               | DAS           | 06/08/2017              | 20/04/2018            | employer 0 | in paid employment         | 05/08/2017                         |
	    	| learner a | 16-18 programme only DAS | maths or english | 403            | 2              | 1            |              | 471      | 06/08/2017 | 06/10/2018       | 06/10/2018      | completed         | 1                     | 06/08/2017                 | 20/10/2018               | Non-DAS       | 21/04/2018              |                       |            | not in paid employment     | 21/04/2018                         |
        ...
        Then the provider earnings and payments break down as follows:
	    	...
	    	| Provider Earned from SFA                | 636.50 | 636.50 | 636.50 | 1636.50 | 636.50  | ... | 636.50 | 636.50 | 636.50 | ... | 3674.36   | 183.64  | 0      | 0     |
...
Scenario:808-AC2- DAS learner, is made redundant outside the last 6 months of planned learning - receives full government funding for the next 12 weeks only
	    ...
	    When an ILR file is submitted with the following data:
	    	| ULN       | learner type             | aim type         | framework code | programme type | pathway code | agreed price | aim rate | start date | planned end date | actual end date | completion status | learning support code | learning support date from | learning support date to |contract type | contract type date from | contract type date to | employer   | employer employment status | employer employment status applies |
	    	| learner a | 16-18 programme only DAS | programme        | 403            | 2              | 1            | 6125         |          | 06/08/2017 | 20/10/2018       | 08/08/2018      | completed         | 1                     | 06/08/2017                 | 20/10/2018               |DAS           | 06/08/2017              | 19/04/2018            | employer 0 | in paid employment         | 05/08/2017                         |
	    	| learner a | 16-18 programme only DAS | maths or english | 403            | 2              | 1            |              | 471      | 06/08/2017 | 06/10/2018       | 06/10/2018      | completed         | 1                     | 06/08/2017                 | 20/10/2018               |Non-DAS       | 20/04/2018              |                       |            | not in paid employment     | 20/04/2018                         |
