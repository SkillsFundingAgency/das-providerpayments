...
Scenario:673-AC02 Non-DAS learner, levy available, provider retrospectively notifies a withdrawal and previously-paid monthly instalments need to be refunded.
	...
	And following learning has been recorded for previous payments:
		| ULN       | learner reference number | learner type          | start date | aim sequence number |  completion status | programme type	|
		| 123		| learner a                | programme only non-DAS| 04/08/2017 | 1                   |  continuing        | 25				|
    ...
    When an ILR file is submitted for the first time on 10/01/18 with the following data:
        | ULN       | learner reference number  | learner type           | start date | planned end date | actual end date | completion status | Total training price | Total training price effective date | Total assessment price | Total assessment price effective date | programme type	|
        | 123		| learner a					| programme only non-DAS | 04/08/2017 | 20/08/2018       | 12/11/2017      | withdrawn         | 9000                 | 04/08/2017                          | 2250                   | 04/08/2017                            | 25				|
	Then the provider earnings and payments break down as follows:
        | Type                           | 08/17 | 09/17 | 10/17 | 11/17 | 12/17 | 01/18 | 02/18 |
        | Provider Earned Total          | 750   | 750   | 750   | 0     | 0     | 0     | 0     |
...
Scenario:894-AC02 - non DAS standard learner, payments made then price is changed retrospectively from beginning
    ...
    Then the provider earnings and payments break down as follows:
        ...
        | Refund taken by SFA            | 0      | 0      | -1348.75 | 0      | 0      |
        | Payment due from Employer      | 0      | 0.0667 | 0.0667   | 0.0667 | 0.0667 |
        | Refund due to employer         | 0      | 0      | -149.86  | 0      | 0      |
...
Scenario:902-AC01 - Non-Levy apprentice, provider changes ULN value in ILR after payments have already occurred
        ...
        | learner reference number | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | aim type         | aim sequence number | framework code | programme type | pathway code |
        | 123                      | 999999999 | programme only non-DAS | 9000         | 05/08/2017 | 20/08/2018       |                 | continuing        | programme        | 1                   | 403            | 2              | 1            |
        | 123                      | 999999999 | programme only non-DAS |              | 05/08/2017 | 20/08/2018       |                 | continuing        | maths or english | 2                   | 403            | 2              | 1            |
        
		
		 And an ILR file is submitted for period R03 with the following data:
        | learner reference number | ULN       | learner type           | agreed price | start date | planned end date | actual end date | completion status | aim type         | aim sequence number | framework code | programme type | pathway code |
        | 123                      | 100000000 | programme only non-DAS | 9000         | 05/08/2017 | 20/08/2018       |                 | continuing        | programme        | 1                   | 403            | 2              | 1            |
        | 123                      | 100000000 | programme only non-DAS |              | 05/08/2017 | 20/08/2018       |                 | continuing        | maths or english | 2                   | 403            | 2              | 1            |
...
Scenario:902-AC02 - Non-Levy apprentice, provider changes learner reference number in ILR after payments have already occurred
        ...
        | 456                      | 999999999 | programme only non-DAS |              | 06/08/2017 | 20/08/2018       |                 | continuing        | maths or english | 2                   | 403            | 2              | 1            |
