...
Feature: Commitment effective dates apply correctly in data collections processing
	...
	Scenario: Change in price month 2
        ...
        Then the provider earnings and payments break down as follows:
            ...
            | Provider Earned Total      | 500   | 1045.45 | 1045.45 | 1045.45 |
            | Provider Earned from SFA   | 500   | 1045.45 | 1045.45 | 1045.45 |
            | Provider Paid by SFA       | 0     | 500     | 1045.45 | 1045.45 |
            | Levy account debited       | 0     | 500     | 1045.45 | 1045.45 |
            | SFA Levy employer budget   | 500   | 1045.45 | 1045.45 | 1045.45 |
            | SFA Levy co-funding budget | 0     | 0       | 0       | 0       |

	
	@ignore
	# This isn't valid live data. There will only be versions of a commitment if there are multiple price episodes in the Ilr,
	#	and they will all have the same priority
	Scenario: Change in price month 2 with priority change after
		Given the following commitments exist:
			...
			| 1             | 2-001      | 2         | employer 0 | provider a | learner a | 01/05/2017 | 01/05/2018 | 15000        | 01/06/2017     | 13/07/2017   |
  ...
  #          | On-program   | commitment 1 v1-001 | commitment 1 v2-001 | commitment 1 v3-001 |
	...
	@ignore
	# This isn't what live data would look like
