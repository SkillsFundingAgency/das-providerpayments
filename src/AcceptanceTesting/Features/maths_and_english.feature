...
#	Tech Guide 102. If an adjustment is required due to prior learning, you must record data in the ‘Funding adjustment for prior learning’ field on the ILR. 
    ...
    Then OBSOLETE - the earnings and payments break down for provider A is as follows:
    	  | Type                                    | 08/17   | 09/17   | 10/17   | 11/17   | 12/17   | 01/18  | 02/18 | ... | 07/18 |
    	  | Provider Earned Total                   | 1039.25 | 1039.25 | 1039.25 | 1039.25 | 1039.25 | 0      | 0     | ... | 0     |
    	  | Provider Paid by SFA                    | 0       | 939.25  | 939.25  | 939.25  | 939.25  | 939.25 | 0     | ... | 0     |
    	  | Payment due from Employer               | 0       | 100     | 100     | 100     | 100     | 100    | 0     | ... | 0     |
    	  | Levy account debited                    | 0       | 0       | 0       | 0       | 0       | 0      | 0     | ... | 0     |
    	  | SFA Levy employer budget                | 0       | 0       | 0       | 0       | 0       | 0      | 0     | ... | 0     |
    	  | SFA Levy co-funding budget              | 0       | 0       | 0       | 0       | 0       | 0      | 0     | ... | 0     |
    	  | SFA non-Levy co-funding budget          | 900     | 900     | 900     | 900     | 900     | 0      | 0     | ... | 0     |
    	  | SFA non-levy additional payments budget | 39.25   | 39.25   | 39.25   | 39.25   | 39.25   | 0      | 0     | ... | 0     |
   ...
   And OBSOLETE - the earnings and payments break down for provider B is as follows:
		  ...
		  | Provider Paid by SFA                    | 0       | 1075.67 | 1075.67 | ... | 1075.67 | 1075.67 |
		  | Payment due from Employer               | 0       | 114.29  | 114.29  | ... | 114.29  | 114.29  |
		  | Levy account debited                    | 0       | 0       | 0       | ... | 0       | 0       |
		  | SFA Levy employer budget                | 0       | 0       | 0       | ... | 0       | 0       |
		  | SFA non-Levy co-funding budget          | 1028.57 | 1028.57 | 1028.57 | ... | 1028.57 | 0       |
    ...
    And the transaction types for the payments for provider B are:
		  ...
		  | On-program                      | 1028.57 | 1028.57 | ... | 1028.57 | 1028.57 |
		  | Completion                      | 0       | 0       | ... | 0       | 0       |
		  | Balancing                       | 0       | 0       | ... | 0       | 0       |
...
#	Tech Guide 102. If an adjustment is required due to prior learning, you must record data in the ‘Funding adjustment for prior learning’ field on the ILR. 
    ...
    And the following commitments exist:
	| Provider   | ULN       | start date | end date   | agreed price | status    | effective from | effective to | stop effective from |
	| provider A | learner a | 06/08/2017 | 08/08/2018 | 15000        | Cancelled | 06/08/2017     | 08/01/2018   | 09/01/2018   |
...
@MathsAndEnglish		  
Scenario: DPP_1283_03 - Levy apprentice, provider submits first ILR in R08 showing ACT2 from the start of learning. Correct Maths or English refunds are processed
    Given levy balance > agreed price for all months
...
@MathsAndEnglish
Scenario: DPP_1283_04 - Levy apprentice, provider submits first ILR in R08 showing ACT1 from the start of learning. Correct Maths or English refunds are processed
    Given levy balance > agreed price for all months
	And the apprenticeship funding band maximum is 9000
